...
export class addRelationUserMeasurement1679582687126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "measurements" ADD CONSTRAINT "UQ_feab566b182e23e4bafc2b31698" UNIQUE ("measurement_date")`);
        await queryRunner.query(`ALTER TABLE "measurements" ADD CONSTRAINT "FK_63398be08cc5c00457b503ddca1" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
