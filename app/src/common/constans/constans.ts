...
export const WEAK_PASSWORD_MESSAGE: string = "password should have from 8 to 24 charachters, have at least 1 number, 1 special character, 1 capital letter, 1 small letter ";
