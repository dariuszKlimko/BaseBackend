...
describe("Users (e2e)", () => {
  ...
  describe("/users/getwithrelation/:id (GET) - get users with relation by id by admin", () => {
    ...
    it("should not return users with relation for not exist user for not by admin", async () => {
      return await getAuthCRUD(
    ...
    it("should not return users with relation for not uuid for not by admin", async () => {
